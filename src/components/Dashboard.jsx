...
import { FaReact } from "react-icons/fa"; // React ikonkasini import qilish
            ...
            <table className="min-w-[33%] border-collapse border border-black mb-4">
              <tbody className="text-[.8rem]">
                <tr>
                  ...
                  <td className="border border-black px-2 py-2">{user.tarkibiy_bolinma_nomi || "Bo'sh"}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-2 font-bold">Xodimning lavozimi</td>
                  <td className="border border-black px-2 py-2">{user.xodim_lavozimi[0] || "Bo'sh"}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-2 font-bold">Xodim F.I.SH.</td>
                  <td className="border border-black px-2 py-2">{user.xodim[0] || "Bo'sh"}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-2 font-bold">Funksional rahbar F.I.SH.</td>
                  <td className="border border-black px-2 py-2">{user.funksional_raxbar[0] || "Bo'sh"}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-2 font-bold">Ma’muriy rahbar F.I.SH.</td>
                  <td className="border border-black px-2 py-2">{user.mamuriy_raxbar[0] || "Bo'sh"}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-2 font-bold">Baxolash davri</td>
                  <td className="border border-black px-2 py-2">{user.baholash_davri[0] || "Bo'sh"}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-2 font-bold">1-Bosqich.Xodim imzosi</td>
                  <td className="border border-black px-2 py-2">{user.birinchi_bosqich_imzo ? user.birinchi_bosqich_imzo.replace("T", " ") : "Bo'sh"}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-2 font-bold">2-Bosqich.Xodim imzosi</td>
                  <td className="border border-black px-2 py-2">{user.ikkinchi_bosqich_imzo ? user.ikkinchi_bosqich_imzo.replace("T", " ") : "Bo'sh"}</td>
                </tr>
              </tbody>
            </table>
                  ...
                  <tbody>
                    {kpiData.map((kpi, index) => (
                      <tr key={kpi.id} className="h-12 text-[.7rem]">
                        ...
                        <td className="border border-black px-2 py-2 text-center">{kpi.izoh || "Bo'sh"}</td>
