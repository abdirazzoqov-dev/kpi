      ...
      {user ? (
        <>
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">{user.xodim[0]}</h1>
            <button
            ...
            <table className="min-w-[30%] border-collapse border border-black mb-4">
              <tbody className="text-[.6rem]">
                <tr>
                  ...
                  <td className="border border-black px-2 py-1\">{user.tarkibiy_bolinma_nomi}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-1 font-bold">Xodimning lavozimi</td>
                  <td className="border border-black px-2 py-1">{user.xodim_lavozimi[0]}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-1 font-bold">Xodim F.I.SH.</td>
                  <td className="border border-black px-2 py-1">{user.xodim[0]}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-1 font-bold">Funksional rahbar F.I.SH.</td>
                  <td className="border border-black px-2 py-1">{user.funksional_raxbar[0]}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-1 font-bold">Ma’muriy rahbar F.I.SH.</td>
                  <td className="border border-black px-2 py-1">{user.mamuriy_raxbar[0]}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-1 font-bold">Baxolash davri</td>
                  <td className="border border-black px-2 py-1">{user.baholash_davri[0]}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-1 font-bold">1-Bosqich.Xodim imzosi</td>
                  <td className="border border-black px-2 py-1">{user.birinchi_bosqich_imzo.replace("T", " ")}</td>
                </tr>
                <tr>
                  <td className="border border-black px-2 py-1 font-bold">2-Bosqich.Xodim imzosi</td>
                  <td className="border border-black px-2 py-1">{user.ikkinchi_bosqich_imzo.replace("T", " ")}</td>
                </tr>
              </tbody>
            </table>
                  ...
                  <tbody>
                    {kpiData.map((kpi, index) => (
                      <tr key={kpi.id} className="h-12 text-[.6rem]">
                        ...
                        <td className="border border-black px-2 py-1 text-center">{kpi.izoh}</td>
                        ...
                        <td className="border border-black px-2 py-1 text-center">{kpi.birinchi_bosqich_sana.replace("T", " ")}</td>
                        <td className="border border-black px-2 py-1 text-center">{kpi.ikkinchi_bosqich_sana.replace("T", " ")}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
